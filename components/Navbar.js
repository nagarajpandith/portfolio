...
export default function Navbar() {
  ...
  return (
        <div className="pt-6 flex justify-center items-center max-w-4xl m-auto w-full cursor-pointer flex-wrap flex-col md:flex-row">
            ...
            <Link href={navbar.folink}><a className="lg:mr-48 hover:text-gray-900 dark:hover:text-gray-100"><span className="link link-underline link-underline-black">{navbar.fourth}</span></a></Link>
            </nav>   
