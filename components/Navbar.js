...
export default function Navbar() {
  ...
  return (
        <div className="pt-6 flex justify-center items-center max-w-4xl m-auto w-full cursor-pointer flex-wrap flex-col md:flex-row">
            ...
            <Link href={navbar.folink}><a className="lg:mr-44 hover:text-gray-900 dark:hover:text-gray-100"><span className="link link-underline link-underline-black">{navbar.fourth}</span></a></Link>
            </nav>   
            <a href={navbar.filink} className="lg:mr-5 block gradient-border transition transition-300 rounded-md px-4 py-2 headline hover:gradient-bg hover:text-off-white group flex gap-2 whitespace-nowrap" download="">
